  ...
  const navItems: NavItem[] = [
    {
      ...
      hasDropdown: true,
      dropdownItems: [
        { key: "carrières", url: "/about/components/careers" },
        { key: "notre équipe", url: "/about/components/team" },
        { key: "notre Valeurs", url: "/about/components/values" },
      ],
      urlKey: "/about",
    },
    {
      ...
      hasDropdown: true,
      dropdownItems: [
        { key: "Financement communautaire", url: "/climate/components/community" },
        { key: "Banques vertes", url: "/climate/components/green-banks" },
        { key: "Solutions climatiques naturelles", url: "/climate/components/natural" },
        { key: "Loisirs de plein air", url: "/climate/components/outdoor" },
      ],
      urlKey: "/climate",
    },
    {
      ...
      hasDropdown: true,
      dropdownItems: [
        { key: " Solutions de durabilité pour les organisations communautaires", url: "/health/components/cbo" },
        { key: " Croissance du marché des organisations de soins gérés", url: "/health/components/mco" },
        { key: "Stratégie SDOH", url: "/health/components/sdoh" },
        { key: "Medicaid d'État", url: "/health/components/state" },
      ],
      urlKey: "/health",
    },
    {
      ...
      hasDropdown: true,
      dropdownItems: [
        { key: "Études de cas", url: "/impact/components/case-studies" },
        { key: "Rapports d'impact", url: "/impact/components/impact-report" },
        { key: "Dans les médias", url: "/impact/components/news" },
        { key: "Carte des projets", url: "/impact/components/projects-map" },
        { key: "Témoignages", url: "/impact/components/testimonials" },
      ],
      urlKey: "/impact",
    },
    {
