  ...
  return (
    <div>
      ...
      <div className="max-w-10/12 mx-auto my-16">
        ...
        <p className="text-base md:text-xl text-left text-gray-600 leading-relaxed my-6">Our work is centered around four solutions: </p>
        {orderList.map((item, index) => (
          <ul className="list-disc pl-6 text-gray-600" key={index}>
            <li key={index} className="text-xl text-cyan-400 pb-3">{item}</li>
          </ul>
        ))}
        <p className="text-base md:text-xl text-left text-gray-600 leading-relaxed my-4">Across these solutions, we focus on solving systems-level problems and accelerating climate smart investments through partnership, finance, and policy innovation.</p>
      </div>
