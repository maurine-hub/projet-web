  ...
  const certifications = [
    {
      ...
      image: "https://images.squarespace-cdn.com/content/v1/5d5b210885b4ce0001663c25/1719508622237-THGLY11H286Z5XBZXLXO/image-asset.png?format=500w",
      description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque, voluptatibus. ",
    },
    {
      title: "Certification 2",
      image: "https://images.squarespace-cdn.com/content/v1/5d5b210885b4ce0001663c25/1578012821589-B6JPHTOXG54A3232U0HK/image.jpg?format=500w",
      description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque, voluptatibus.",
    },
    {
    ...
    <div>
      ...
      <div className="w-full max-sm:px-6 md:max-w-10/12 md:mx-auto my-24">
        ...
        <div className="bg-gray-200 rounded-lg  md:p-16 mt-6">
          ...
          <p className="text-lg md:text-2xl text-gray-600 ">This leads to stronger teams,
        ...
        <div>
          <h1 className="capitalize text-xl md:text-3xl font-bold text-center text-gray-700 mt-10">awards and certifications</h1>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 my-16">
            {certifications.map((cert) => (
              <div key={cert.title} className="flex flex-col items-center">
                <img src={cert.image} alt={cert.title} className="w-48 h-48 rounded-full" />
                <p className="text-sm md:text-base text-center font-semibold text-gray-600 mt-2">{cert.description}</p>
              </div>
            ))}
          </div>
        </div>
